# -*- coding: utf-8 -*-
# https://github.com/JavisPeng/ecg_pytorch/blob/master/models/resnet.py
'''
@time: 2019/9/8 20:14
直接修改torch的resnet
@ author: javis
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_channels=12, num_classes=55):
        self.inplanes = 64
        super(ResNet, self).__init__()
        # 12是input_size，
        self.conv1 = nn.Conv1d(num_channels, 64, kernel_size=15, stride=2, padding=7,
                               bias=False)
